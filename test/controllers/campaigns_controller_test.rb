...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { email: @campaign.email, name: @campaign.name } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { email: @campaign.email, name: @campaign.name } }
